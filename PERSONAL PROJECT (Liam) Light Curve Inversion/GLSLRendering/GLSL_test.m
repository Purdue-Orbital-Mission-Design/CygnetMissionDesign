...
[win , winRect] = Screen('OpenWindow', screenid, [], [100 100 600 600]);
...
glsl(1)=LoadGLSLProgramFromFiles([shaderpath 'Toonshader'],1);
...
times = struct('start', 0.0, 'step', 0.01, 'stop', 5);
...
while (time_index < length(q1) + 1)
    ...
    [angle, axis] = AngleAxis(q1(mod(time_index, length(q1)) + 1));
